...
const styles: Record<string, CSSProperties> = {
  root: { display: 'flex', minWidth: 0, height: '100%', flexDirection: 'column', background: '#fafafa', borderLeft: '1px solid #e3e3e7', color: '#202124' },
  header: { display: 'flex', minHeight: 56, alignItems: 'center', padding: '0 14px', borderBottom: '1px solid #e3e3e7', background: '#ffffff' },
  ...
  meta: { color: '#73737c', fontSize: 10 },
  backButton: { display: 'grid', width: 30, height: 30, placeItems: 'center', padding: 0, border: '1px solid #e1e1e5', borderRadius: 6, background: '#ffffff', color: '#45454d', cursor: 'pointer' },
  scrollBody: { minHeight: 0, overflowY: 'auto', padding: '16px 15px 26px' },
  taskSummary: { display: 'grid', gap: 9, padding: '12px', border: '1px solid #e3e3e7', borderRadius: 6, background: '#ffffff', boxShadow: 'none' },
  summaryRow: { display: 'grid', gridTemplateColumns: '72px minmax(0,1fr)', gap: 8, alignItems: 'baseline', color: '#6a6a73', fontSize: 11 },
  summaryBlock: { display: 'grid', gap: 4, color: '#6a6a73', fontSize: 11 },
  sectionHeading: { display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', gap: 8, margin: '18px 2px 9px', color: '#34343a', fontSize: 12 },
  categoryList: { display: 'grid', gap: 9 },
  category: { display: 'grid', gridTemplateColumns: '32px minmax(0,1fr)', alignItems: 'center', border: '1px solid #e3e3e7', borderRadius: 6, background: '#ffffff', boxShadow: 'none' },
  selected: { border: '1px solid #bed2ff', background: '#eef4ff', boxShadow: 'inset 2px 0 #2563eb' },
  ...
  categoryIcon: { display: 'grid', width: 34, height: 34, placeItems: 'center', borderRadius: 6, background: '#f1f3f5', color: '#50515b' },
  ...
  categoryDescription: { display: '-webkit-box', overflow: 'hidden', color: '#70717a', fontSize: 10, lineHeight: 1.4, WebkitBoxOrient: 'vertical', WebkitLineClamp: 2 },
  categoryCount: { minWidth: 30, padding: '3px 6px', borderRadius: 5, background: '#eef1f6', color: '#4e5d76', fontSize: 11, fontWeight: 720, textAlign: 'center' },
  chevron: { color: '#85858e', flex: '0 0 auto' },
  check: { display: 'grid', width: 21, height: 21, placeItems: 'center', justifySelf: 'center', padding: 0, border: '1px solid #d1d1d6', borderRadius: 5, background: '#ffffff', color: '#fff', cursor: 'pointer', flex: '0 0 auto' },
  checkSelected: { border: '1px solid #2563eb', background: '#2563eb' },
  hint: { margin: '12px 3px 0', color: '#70717a', fontSize: 10, lineHeight: 1.55 },
  ...
  search: { display: 'flex', alignItems: 'center', gap: 8, height: 36, padding: '0 10px', border: '1px solid #e1e1e5', borderRadius: 6, background: '#ffffff', color: '#70717a' },
  ...
  listMeta: { display: 'flex', justifyContent: 'space-between', padding: '9px 3px 7px', color: '#70717a', fontSize: 10 },
  ...
  taskButton: { display: 'grid', width: '100%', minWidth: 0, gridTemplateColumns: '40px minmax(0,1fr) 18px', gap: 10, alignItems: 'center', marginBottom: 8, padding: '11px 10px', border: '1px solid #e3e3e7', borderRadius: 6, background: '#ffffff', color: 'inherit', textAlign: 'left', cursor: 'pointer', boxShadow: 'none' },
  taskButtonIcon: { display: 'grid', width: 40, height: 40, placeItems: 'center', borderRadius: 6 },
  taskButtonIconApplication: { background: '#eaf1ff', color: '#2563eb' },
  taskButtonIconResearch: { background: '#eef0f4', color: '#556273' },
  ...
  taskStatus: { flex: '0 0 auto', padding: '3px 6px', borderRadius: 5, background: '#f1f1f3', color: '#595963', fontSize: 9, fontWeight: 650 },
  taskIdentity: { display: 'flex', minWidth: 0, alignItems: 'center', gap: 6, overflow: 'hidden', color: '#70717a', fontSize: 10, whiteSpace: 'nowrap' },
  taskCounts: { display: 'flex', minWidth: 0, flexWrap: 'wrap', gap: '4px 9px', color: '#595963', fontSize: 10 },
  taskDate: { color: '#83838c', fontSize: 9 },
  record: { display: 'grid', gridTemplateColumns: '31px minmax(0,1fr)', alignItems: 'center', marginBottom: 8, border: '1px solid #e3e3e7', borderRadius: 6, background: '#ffffff' },
  ...
  thumbnail: { width: 44, height: 44, objectFit: 'cover', borderRadius: 6, background: '#f0f0f2' },
  thumbnailFallback: { display: 'grid', width: 44, height: 44, placeItems: 'center', borderRadius: 6, background: '#f0f0f2', color: '#5c5c66' },
  ...
  recordSubtitle: { display: '-webkit-box', overflow: 'hidden', color: '#686871', fontSize: 10, lineHeight: 1.4, WebkitBoxOrient: 'vertical', WebkitLineClamp: 2 },
  recordMeta: { overflow: 'hidden', color: '#83838c', fontSize: 9, textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  pagination: { display: 'flex', justifyContent: 'space-between', gap: 8, paddingTop: 8 },
  pageButton: { display: 'flex', minHeight: 32, alignItems: 'center', gap: 4, padding: '0 10px', border: '1px solid #e1e1e5', borderRadius: 6, background: '#ffffff', color: '#4d4d56', fontSize: 10, cursor: 'pointer' },
