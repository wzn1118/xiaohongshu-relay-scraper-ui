...
const styles: Record<string, CSSProperties> = {
  root: { display: 'flex', minWidth: 0, height: '100%', flexDirection: 'column', background: '#f7f8f6', borderLeft: '1px solid #d9dfda', color: '#202522' },
  header: { display: 'flex', minHeight: 66, alignItems: 'center', padding: '0 16px', borderBottom: '1px solid #dfe4e0', background: '#fbfcfb' },
  headerTitleRow: { display: 'flex', minWidth: 0, alignItems: 'center', gap: 8 },
  headerCopy: { display: 'grid', minWidth: 0, gap: 3 },
  heading: { overflow: 'hidden', fontSize: 14, lineHeight: 1.3, fontWeight: 680, textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  meta: { color: '#65706a', fontSize: 11 },
  backButton: { display: 'grid', width: 32, height: 32, placeItems: 'center', padding: 0, border: '1px solid #d3dad5', borderRadius: 5, background: '#fff', color: '#3d4942', cursor: 'pointer' },
  scrollBody: { minHeight: 0, overflowY: 'auto', padding: '14px 14px 24px' },
  taskSummary: { display: 'grid', gap: 9, padding: '12px', border: '1px solid #dce2de', borderRadius: 6, background: '#fff' },
  ...
  categoryList: { display: 'grid', gap: 8 },
  category: { display: 'grid', gridTemplateColumns: '32px minmax(0,1fr)', alignItems: 'center', border: '1px solid #d9dfda', borderRadius: 6, background: '#fff' },
  selected: { border: '1px solid #9dccbc', background: '#edf7f3' },
  ...
  categoryIcon: { display: 'grid', width: 34, height: 34, placeItems: 'center', borderRadius: 5, background: '#edf2ef', color: '#3f4e46' },
  ...
  categoryCount: { minWidth: 30, padding: '3px 6px', borderRadius: 4, background: '#e9eefb', color: '#40557a', fontSize: 11, fontWeight: 680, textAlign: 'center' },
  chevron: { color: '#7a837e', flex: '0 0 auto' },
  check: { display: 'grid', width: 21, height: 21, placeItems: 'center', justifySelf: 'center', padding: 0, border: '1px solid #b9c2bc', borderRadius: 4, background: '#fff', color: '#fff', cursor: 'pointer', flex: '0 0 auto' },
  checkSelected: { border: '1px solid #0b7a62', background: '#0b7a62' },
  ...
  listLayout: { display: 'grid', minHeight: 0, flex: 1, gridTemplateRows: 'auto auto minmax(0,1fr) auto', padding: '12px 11px' },
  search: { display: 'flex', alignItems: 'center', gap: 8, height: 40, padding: '0 11px', border: '1px solid #d2dad5', borderRadius: 6, background: '#fff', color: '#68736d' },
  ...
  taskButton: { display: 'grid', width: '100%', minWidth: 0, gridTemplateColumns: '40px minmax(0,1fr) 18px', gap: 10, alignItems: 'center', marginBottom: 8, padding: '12px 10px', border: '1px solid #d9dfda', borderRadius: 6, background: '#fff', color: 'inherit', textAlign: 'left', cursor: 'pointer' },
  taskButtonIcon: { display: 'grid', width: 40, height: 40, placeItems: 'center', borderRadius: 6 },
  taskButtonIconApplication: { background: '#e6f2ee', color: '#176b58' },
  taskButtonIconResearch: { background: '#e9eefb', color: '#405a82' },
  ...
  taskStatus: { flex: '0 0 auto', padding: '3px 6px', borderRadius: 4, background: '#eef1ef', color: '#52605a', fontSize: 9, fontWeight: 600 },
  ...
  record: { display: 'grid', gridTemplateColumns: '31px minmax(0,1fr)', alignItems: 'center', marginBottom: 7, border: '1px solid #dce2de', borderRadius: 6, background: '#fff' },
  ...
  thumbnail: { width: 44, height: 44, objectFit: 'cover', borderRadius: 5, background: '#eef1ef' },
  thumbnailFallback: { display: 'grid', width: 44, height: 44, placeItems: 'center', borderRadius: 5, background: '#eef1ef', color: '#52635a' },
  ...
  pageButton: { display: 'flex', minHeight: 32, alignItems: 'center', gap: 4, padding: '0 10px', border: '1px solid #d3dad5', borderRadius: 5, background: '#fff', color: '#46534c', fontSize: 10, cursor: 'pointer' },
  detail: { minHeight: 0, overflowY: 'auto', padding: '14px 14px 26px' },
